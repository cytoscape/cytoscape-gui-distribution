...
/**
 * Tests nested groups, all of them collapsed.
 */
public class Cy3CollapsedGroupsSessionLoadingTest extends BasicIntegrationTest {

	@Before
	public void setup() throws Exception {
		sessionFile = File.createTempFile("test", ".cys");
		Files.copy(getClass().getResourceAsStream("/testData/session3x/nestedGroups_collapsed.cys"), sessionFile.toPath(), StandardCopyOption.REPLACE_EXISTING);
	...
	private void checkNetwork() {
		...
		checkNodeEdgeCount(net, 2, 1, 0, 0);
	}
	...
	private void checkGroups() {
		...
		assertTrue(net.containsNode(gn2));
		...
		// Meta-edges
		final CyEdge me = getEdgeByName(net, "meta-null");
		assertNotNull(me);
		assertEquals(gn2, me.getSource());
		assertEquals(n4, me.getTarget());
	}
}
